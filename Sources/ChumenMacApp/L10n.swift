...
enum L10n {
    ...
    private static let zhHans: [Key: String] = [
        ...
        .pinDescription: "可选：PIN 可以保护配置密钥；应用锁屏独立，默认关闭。",
        .pinInfoConfigEncrypted: "配置始终加密，避免订阅和节点明文被扫描。",
        .pinInfoPINProtectsKey: "启用后，PIN 会保护 age 私钥；不启用也不影响启动内核。",
        ...
        .pinSetupRequired: "可在设置中启用 PIN 保护；应用锁屏是独立选项，默认关闭。",
        .pinRequired: "输入 PIN 解密配置",
        ...
        .pinLockAppOnLaunchHint: "可选；开启后启动时必须输入这个 PIN，关闭则自动解密。",
        .pinLockNow: "立即锁屏",
        ...
        .coreNotFound: "未找到可执行的 chumen-door 内核",
    ...
    private static let en: [Key: String] = [
        ...
        .pinDescription: "Optional: PIN can protect the config key. App lock is separate and defaults off.",
        .pinInfoConfigEncrypted: "Configs stay encrypted to avoid plaintext proxy scans.",
        .pinInfoPINProtectsKey: "When enabled, PIN protects the age private key. Core start is not blocked.",
        ...
        .pinSetupRequired: "PIN protection can be enabled in Settings; app lock is separate and defaults off.",
        .pinRequired: "Enter PIN to decrypt configs",
        ...
        .pinLockAppOnLaunchHint: "Optional; when enabled, launch requires this PIN. Otherwise Chumen auto-unlocks.",
        .pinLockNow: "Lock Now",
        ...
        .coreNotFound: "No executable chumen-door candidate found",
